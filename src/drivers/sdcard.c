...
/**
 * @brief Obtém o cartão SD pelo nome
 * @param name Nome do cartão SD
 * @return Ponteiro para o cartão SD
 */
...
/**
 * @brief Obtém o sistema de arquivos pelo nome
 * @param name Nome do cartão SD
 * @return Ponteiro para o sistema de arquivos
 */
...
/**
 * @brief Configura a data e hora do RTC
 */
...
/**
 * @brief Obtém o espaço livre no cartão SD
 */
...
/**
 * @brief Lista os arquivos do cartão SD
 */
void run_ls(void)
{
    const char *arg1 = strtok(NULL, " ");
